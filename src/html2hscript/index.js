	...
	if(typeof define === "function") {
		...
		if(define.cmd){
			define(function(require, exports, module){
				return factory(require('htmlparser2'),require('to-camel-case'),require('ent'),require('underscore'),require('./lib/svg-namespaces'));
			})
		}
	} else if(typeof module === "object" && module.exports) {
		module.exports = factory(require('./virtual-hyperscript/index'));
	}
}(this, function(htmlparser2,camel,ent,_,svgNamespace){
    var Parser = htmlparser2.Parser,
    isEmpty = _.isEmpty,
    thisIsSVGTag = svgNamespace.thisIsSVGTag,
    getSVGNamespace = svgNamespace.getSVGNamespace,
    getSVGAttributeNamespace = svgNamespace.getSVGAttributeNamespace,
    elementStack = [];
