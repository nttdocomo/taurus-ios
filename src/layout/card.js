...
;(function (root, factory) {
  if (typeof define === 'function') {
    ...
    // the AMD loader.
    if (define.amd) {
      define(['../core/define', './default'], function () {
        return (root.Class = factory())
      })
    }
    if (define.cmd) {
      define(function (require, exports, module) {
        return (root.Class = factory(require('../core/define'), require('./default')))
      })
    }
    ...
    module.exports = (root.Class = factory(require('../core/define'), require('./default')))
  } else {
    root.Class = factory()
  }
}(this, function (define, Default) {
